...
import br.dev.motivationapp.helper.MotivationConstants.PHRASEFILTER
import kotlin.random.Random

data class Phrase(val description: String, val category: Int, val language: String)

class PhraseRepository {
    private val all = PHRASEFILTER.ALL
    private val happy = PHRASEFILTER.HAPPY
    private val sunny = PHRASEFILTER.SUNNY
    ...
    fun getPhrase(value: Int, language: String): String {
        ...
        val randomInt = Random.nextInt(filteredPhrases.size)

        // Retorna string
        return filteredPhrases[randomInt].description
    }
}